<?php /*a:3:{s:69:"/www/wwwroot/yueling/application/admin/view/info/information_add.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select name="type" datatype="*"  class="input-text selectwith">
					<?php foreach($info as $f): ?>
					<option value="<?php echo htmlentities($f['type']); ?>" <?php if($type == $f['type']): ?>selected<?php endif; ?> ><?php echo htmlentities($f['name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="col-4"> </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="upload-img" style="width: 170px;height: 170px;">
					...
					<img id="img-show" src="<?php echo htmlentities($img); ?>" class="img-polaroid" width="170" height="170" alt="上传图片" title="上传图片">
				</div>
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  class="input-text" id="title" type="text/plain" value="<?php echo htmlentities($title); ?>"  placeholder="最多40字" name="title" maxlength="40">
			</div>
				<div class="col-4"> </div>
		</div>
		<div class="row cl">
