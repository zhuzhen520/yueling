<?php /*a:3:{s:60:"/www/wwwroot/yueling/application/admin/view/admin/input.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="" method="post" class="form form-horizontal" id="form-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities((isset($data['nickname']) && ($data['nickname'] !== '')?$data['nickname']:'')); ?>" name="data[nickname]" datatype="*" placeholder="请输入管理员昵称"  nullmsg="请输入管理员昵称">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities((isset($data['username']) && ($data['username'] !== '')?$data['username']:'')); ?>" placeholder="请输入管理员账号" name="data[username]" datatype="*" nullmsg="请输入管理员账号" <?php if(isset($data['is_default']) && $data['is_default'] == 1): ?>disabled<?php endif; ?> >
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <span style="color:red">*<?php if(isset($data['id']) && $data['id'] > 0): ?>密码若不填写不修改密码<?php else: ?>密码若不填写默认为:123456<?php endif; ?></span>
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <?php foreach(config('menu.menu') as $k => $v): if($v['show'] == true): ?>
                    <div style="margin-top: 10px;font-weight: bold;"><?php echo htmlentities($v['name']); ?></div>
                        <?php foreach($v['sub'] as $x => $y): ?>
                        <div class="radio-box">
                            <input type="checkbox" id="role-<?php echo htmlentities($k); ?>-<?php echo htmlentities($x); ?>" value="<?php echo htmlentities($y['uri']); ?>" name="data[role][]" <?php if(isset($data['role']) && in_array($y['uri'], $data['role'])): ?> checked <?php endif; ?>>
                            <label for="role-<?php echo htmlentities($k); ?>-<?php echo htmlentities($x); ?>"><?php echo htmlentities($y['name']); ?></label>
                        </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                <?php endforeach; ?>
