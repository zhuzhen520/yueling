<?php /*a:3:{s:64:"/www/wwwroot/yueling/application/admin/view/user/teamprofit.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="pd-20">
    <form action="" method="get">
        <div class="text-c">        
            ...
            <input type="text" class="input-text" style="width:250px" placeholder="请输入用户id" name="word" value="<?php echo input('word'); ?>">
                ...
                <tbody>
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                        <tr class="text-c">
                            ...
                            <td><?php echo floatval($v['num']); ?></td>
                            <td><?php echo floatval($v['perfor'] * 100); ?>%</td>
                            ...
                            <td>
                                <?php switch($v['status']): case "0": ?> <span class="label label-default radius">等待发放</span> <?php break; case "1": ?> <span class="label label-primary radius">已发放</span> <?php break; case "2": ?> <span class="label label-default radius">已撤消</span> <?php break; ?>
                                <?php endswitch; ?>
                            </td>
                        </tr>
