<?php /*a:3:{s:62:"/www/wwwroot/yueling/application/admin/view/info/infolist.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c" id="tr<?php echo htmlentities($v['id']); ?>">
				...
				<td><?php echo release($v['type']); ?></td>
				<td><?php echo $v['title']; ?></td>
				<td>
					<?php if($v['user_id'] ==  0): ?>
						所有人
					<?php else: ?>
						指定用户：<?php echo htmlentities($v['user_id']); ?>
					<?php endif; ?>
				</td>
				<td> <?php echo htmlentities($v['admin']); ?></td>
				<td>
					<a class="btn btn-primary radius" data-title="编辑查看" onClick="new_open('添加/编辑','/info/infolist_add?id=<?php echo htmlentities($v['id']); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe6dc;</i>编辑查看</a>
				</td>
