<?php /*a:3:{s:65:"/www/wwwroot/yueling/application/admin/view/info/information.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c" id="tr<?php echo htmlentities($v['id']); ?>">
				...
				<td style="padding: 0"><img src="<?php echo htmlentities($v['img']); ?>" style="width: 60px;height: 60px;" onclick="showimg('<?php echo htmlentities($v['img']); ?>')"></td>
				<td>
					<?php switch($v['type']): case "1": ?> <span class="label label-primary radius"  style="background-color: #8C7853">约邻之星</span>  <?php break; case "2": ?> <span class="label label-primary radius" style="background-color: #DAA520">约邻资讯</span> <?php break; case "3": ?> <span class="label label-primary radius" style="background-color: #FF0000">约邻学院</span> <?php break; case "4": ?> <span class="label label-primary radius" style="background-color: #FF00FF">活动</span> <?php break; ?>
					<?php endswitch; ?>
				</td>
				<td> <?php echo htmlentities($v['title']); ?></td>
				<td>
					<a class="btn btn-primary radius" data-title="编辑查看" onClick="new_open('添加/编辑','/info/information_add?id=<?php echo htmlentities($v['id']); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe6dc;</i>编辑查看</a>
				</td>
