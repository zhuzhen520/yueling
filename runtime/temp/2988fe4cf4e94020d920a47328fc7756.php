<?php /*a:3:{s:66:"/www/wwwroot/yueling/application/admin/view/info/infolist_add.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-add">
        ...
        <div class="row cl" id="users">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input  class="input-text selectwith" id="user_id" type="text/plain" value="<?php echo htmlentities($user_id); ?>"  placeholder="所有人：0 / 接收用户id" name="user_id" maxlength="40">
