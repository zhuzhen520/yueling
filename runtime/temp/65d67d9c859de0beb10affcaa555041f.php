<?php /*a:3:{s:64:"/www/wwwroot/yueling/application/admin/view/user/user_skill.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c" id="tr<?php echo htmlentities($v['user_id']); ?>">
                ...
                <td class="td-manage">
                    ...
                    <a style="text-decoration:none" class="btn btn-primary ml-5" onclick="member_sta(this,<?php echo htmlentities($v['id']); ?>,1)"  href="javascript:void(0);" title="通过"><i class="Hui-iconfont">&#xe615;</i></a>
                    <a style="text-decoration:none" class="btn btn-warning ml-5" onclick="member_sta(this,<?php echo htmlentities($v['id']); ?>,2)" title="驳回"><i class="Hui-iconfont">&#xe60b;</i></a>
