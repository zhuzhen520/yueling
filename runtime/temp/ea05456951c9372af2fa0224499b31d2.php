<?php /*a:3:{s:65:"/www/wwwroot/yueling/application/admin/view/system/recommend.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
			...
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				<li class="item"  style="width: 250px;height: 444.7px; margin-bottom: 40px">
					<div class="portfoliobox" style="width: 250px;">
						...
						<img src="<?php echo htmlentities($v['image_path']); ?>" style="width: 250px;height: 444.7px;" onclick="showimg('<?php echo htmlentities($v['image_path']); ?>')">
					</div>
				</li>
