<?php /*a:3:{s:62:"/www/wwwroot/yueling/application/admin/view/system/banner.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<!-- <a href="javascript:;" onclick="member_add('添加首页图片','<?php echo url('banner_add',array('type'=>'index')); ?>')" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe625;</i> 添加图轮播片</a> -->
			<a href="javascript:;" onclick="new_open('添加图轮播片','/system/banner_add?type=app')" class="btn btn-success radius">
			<i class="Hui-iconfont">&#xe672;</i> 添加首页轮播图</a>
			 <a href="javascript:;"  onclick="new_open('添加资讯轮播图','/system/banner_add?type=shop')" class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe625;</i> 添加资讯轮播图</a>
			<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
			<i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
		</span> 
		<span class="r">共有图片：<strong id="count"><?php echo count($list); ?></strong> 张</span> </div>
	<div class="portfolio-content">
		<ul class="cl portfolio-area">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				<li class="item" style="margin-right: 210px; margin-bottom: 20px">
					<div class="portfoliobox" style="width: 350px;">
						...
						<?php switch($v['type']): case "app": ?> <span class="label label-success radius">首页轮播图</span> <?php break; case "shop": ?><span class="label label-primary radius">资讯轮播图</span> <?php break; case "money": ?> <span class="label label-success radius">钱包</span> <?php break; ?>
						<?php endswitch; ?>
						<input class="checkbox" name="del[]" type="checkbox" value="<?php echo htmlentities($v['id']); ?>">
						<!--<div class="picbox"><a href="<?php echo htmlentities($v['image_path']); ?>" data-lightbox="gallery" data-title="">-->
						<!--<img src="<?php echo htmlentities($v['image_path']); ?>"></a></div>-->
						<img src="<?php echo htmlentities($v['image_path']); ?>" style="width: 343px;height: 159px;" onclick="showimg('<?php echo htmlentities($v['image_path']); ?>')">
					</div>
				</li>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.post("<?php echo url('banner_del'); ?>",{id:id},function(data){
			if(data.status == 'y'){
				layer.msg(data.info,{icon:1,time:1000});
