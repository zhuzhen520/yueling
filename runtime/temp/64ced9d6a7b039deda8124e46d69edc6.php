<?php /*a:3:{s:63:"/www/wwwroot/yueling/application/admin/view/user/head_auth.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/header.html";i:1567821037;s:62:"/www/wwwroot/yueling/application/admin/view/public/footer.html";i:1567821037;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="mt-20">
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c" id="tr<?php echo htmlentities($v['id']); ?>">
                ...
                <td><img src="<?php echo htmlentities($v['img_apply']); ?>" style="width: 40px;height: 40px;" onclick="showimg('<?php echo htmlentities($v['img_apply']); ?>')"></td>

                <td class="td-manage">

                    <a style="text-decoration:none" class="btn btn-primary ml-5" onclick="head_status(this,<?php echo htmlentities($v['id']); ?>,1)"  href="javascript:void(0);" title="通过"><i class="Hui-iconfont">&#xe615;</i></a>
                    <a style="text-decoration:none" class="btn btn-warning ml-5" onclick="head_status(this,<?php echo htmlentities($v['id']); ?>,2)" title="驳回"><i class="Hui-iconfont">&#xe60b;</i></a>
...
<script type="text/javascript">
    function head_status(obj,id,status){
        layer.confirm('确认要修改吗？',function(index){
            $.post("<?php echo url('head_status'); ?>",{id:id,status:status},function(data){
    ...
    function member_sta(obj,id,status){
        layer.confirm('确认要修改吗？',function(index){
            $.post("<?php echo url('user_skill_sta'); ?>",{id:id,status:status},function(data){
                layer.msg(data.info,{icon:1,time:1000});
                window.location.reload();
            },'json');
        });
