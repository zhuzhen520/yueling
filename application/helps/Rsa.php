...
class Rsa
{
    ...
    public function __construct($private = APP_EXTEND . 'rsa/rsa_private_key.pem', $public = APP_EXTEND . 'rsa/rsa_public_key.pem')
    {
        $this->_config['private_key'] = $this->_getContents($private);
        $this->_config['public_key'] = $this->_getContents($public);
    }
